                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-9 col-lg-8 mx-auto">
                                    ...
                                    <h5 class="login-heading mb-4">Resetar Senha</h5>
                                    ...
                                    <div class="form-label-group">
                                        <input type="password" id="inputConfirmPassword" placeholder="Senha"
                                    ...
                                    <button
                                        class="btn btn-lg text-white btn-block btn-login text-uppercase font-weight-bold mb-2"
                                        type="submit">Resetar Senha</button>
                                </div>
                            </div>
                        </div>
                    </div>

@extends('layouts.app', ['page' => 'Parceiros', 'pageSlug' => 'partners'])
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <a href="{{ route('partners.create') }}" class="btn btn-sm btn-primary">Adicionar Novo</a>
                    </div>
                    @endcan
                </div>
            </div>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <form action="{{ route('partners.destroy', $item->id) }}" method="post"
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('partners.show', $item) }}">Visualizar</a>
                                                @endcan
                                                @can('partners_edit')
                                                <a class="dropdown-item"
                                                    href="{{ route('partners.edit', $item) }}">Editar</a>
                                                @endcan
                                                @can('partners_delete')

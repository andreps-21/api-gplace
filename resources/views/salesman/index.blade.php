                    ...
                    <div class="row">
                        ...
                        @can('salesman_create')
                            <div class="col-4 text-right">
                                <a href="{{ route('salesman.create') }}" class="btn btn-sm btn-primary">Adicionar Novo</a>
                            </div>
                        @endcan
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div style="margin-top: -20px;" class="col-md-12 text-right">
                            ...
                            <a id="clear-filter" style="font-size: 9px;" class="btn btn-sm btn-danger"
                                href="{{ route('salesman.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="9"
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <form action="{{ route('salesman.destroy', $item->id) }}"
                                                        method="post" id="form-{{ $item->id }}">
                                                        @csrf
                                                        @method('delete')
                                                        @can('salesman_view')
                                                            <a class="dropdown-item"
                                                                href="{{ route('salesman.show', $item) }}">Visualizar</a>
                                                        @endcan
                                                        @can('salesman_edit')
                                                            <a class="dropdown-item"
                                                                href="{{ route('salesman.edit', $item) }}">Editar</a>
                                                        @endcan
                                                        @can('salesman_delete')

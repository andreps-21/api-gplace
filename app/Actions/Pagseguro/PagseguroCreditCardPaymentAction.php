...
class PagseguroCreditCardPaymentAction
{
    public function execute(Order $order, Request $request, bool $isSandbox, string $token)
    {
        ...
        $data = [
            ...
            "charges" => [
                [
                    ...
                    'payment_method' => [
                        'type' => 'CREDIT_CARD',
                        'soft_descriptor' => substr($order->store->name,0, 17),
                        'capture' => true,
                        'installments' => $request->card['installments'],
                        'card' => [
                            'encrypted' => $request->card['encrypted']
                        ]
                    ],
                ]
            ],
        ...
        $result = [
            ...
            'payed' => $checkout['charges'][0]['status'] == 'PAID'
        ];

...
return [
    ...
    'use-sandbox' =>  env('MELHOR_ENVIO_SANDBOX', true),
    ...
    'credentials' => [ //INFORME AS CREDENCIAIS PADRÕES DE SUA LOJA, MAS PORDERÁ SER ALTERADA EM RUNTIME
        'email' => env('MELHOR_ENVIO_EMAIL', null),
        'token' => env('MELHOR_ENVIO_TOKEN', null),
        'client-id' => env('MELHOR_ENVIO_CLIENT_ID', null),
        'client-secret' => env('MELHOR_ENVIO_CLIENT_SECRET', null),
    ],
    ...
    'url' => [
        'calculate-freight' => '/api/v2/me/shipment/calculate',
    ],
];
